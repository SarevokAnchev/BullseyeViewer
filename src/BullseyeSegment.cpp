...
#include <bullseye/BullseyeSegment.h>

BullseyeSegment::BullseyeSegment(double start_radius_, double radius_, double start_angle_, double angle_)
        : start_radius(start_radius_), radius(radius_), start_angle(start_angle_), angle(angle_)
{}

bool BullseyeSegment::contains(double a, double r) const
{
